...
\noindent
\code{average\_damp} is a procedure that takes as its argument a procedure
...
\code{f(x)}.  For example, applying \code{average\_damp} to the \code{square}
...
\noindent
Using \code{average\_damp}, we can reformulate the square-root procedure as
follows:
...
\noindent
Like \code{average\_damp}, \code{deriv} is a procedure that takes a procedure as
...
\noindent
The \code{newton\_transform} procedure expresses the formula at the beginning of
this section, and \code{newtons\_method} is readily defined in terms of this.
...
\begin{exerciseGroup}
\phantomsection\label{Exercise 1.40}
\exerciseHeading{Exercise 1.40:} Define a procedure \code{cubic}
that can be used together with the \code{newtons\_method} procedure in
...
\phantomsection\label{Exercise 1.41}
\exerciseHeading{Exercise 1.41:} Define a procedure \code{double}
...
\phantomsection\label{Exercise 1.42}
\exerciseHeading{Exercise 1.42:} Let \( f \) and \( g \) be two
...
\phantomsection\label{Exercise 1.43}
\exerciseHeading{Exercise 1.43:} If \( f \) is a numerical function
...
\phantomsection\label{Exercise 1.44}
\exerciseHeading{Exercise 1.44:} The idea of \newterm{smoothing} a
...
\phantomsection\label{Exercise 1.45}
\exerciseHeading{Exercise 1.45:} We saw in \link{Section 1.3.3}
...
\( n^{\mathrm{th}} \) roots using \code{fixed\_point}, \code{average\_damp}, and the
\code{repeated} procedure of \link{Exercise 1.43}.  Assume that any arithmetic
operations you need are available as primitives.

\phantomsection\label{Exercise 1.46}
\exerciseHeading{Exercise 1.46:} Several of the numerical methods
...
\code{iterative\_improve} that takes two procedures as arguments: a method for
telling whether a guess is good enough and a method for improving a guess.
\code{iterative\_improve} should return as its value a procedure that takes a
...
\code{fixed\_point} procedure of \link{Section 1.3.3} in terms of
\code{iterative\_improve}.
\end{exerciseGroup}
